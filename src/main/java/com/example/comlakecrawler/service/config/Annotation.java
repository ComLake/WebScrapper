...
public class Annotation {
    public static String ULAKE_LOGOUT = "http://comlakeapi-dev.ap-southeast-1.elasticbeanstalk.com/api/auth/logout";
    public static String ULAKE_REGISTER = "http://comlakeapi-dev.ap-southeast-1.elasticbeanstalk.com/api/auth/signup";
    public static String ULAKE_UPLOAD_FILE = "http://comlakeapi-dev.ap-southeast-1.elasticbeanstalk.com/api/files";
    public static String ULAKE_REFRESH_TOKEN = "http://localhost:5000/api/auth/refresh-token";
    public static String ULAKE_SIGN_IN = "http://comlakeapi-dev.ap-southeast-1.elasticbeanstalk.com/api/auth/signin";
